...
export const GET_ALL_RESTAURANTS_PUBLIC_REQUEST = "GET_ALL_RESTAURANTS_PUBLIC_REQUEST";
export const GET_ALL_RESTAURANTS_PUBLIC_SUCCESS = "GET_ALL_RESTAURANTS_PUBLIC_SUCCESS";
export const GET_ALL_RESTAURANTS_PUBLIC_FAILURE = "GET_ALL_RESTAURANTS_PUBLIC_FAILURE";
...
export const GET_RESTAURANT_PUBLIC_BY_ID_REQUEST = "GET_RESTAURANT_PUBLIC_BY_ID_REQUEST";
export const GET_RESTAURANT_PUBLIC_BY_ID_SUCCESS = "GET_RESTAURANT_PUBLIC_BY_ID_SUCCESS";
export const GET_RESTAURANT_PUBLIC_BY_ID_FAILURE = "GET_RESTAURANT_PUBLIC_BY_ID_FAILURE";
...
export const GET_RESTAURANTS_CATEGORY_PUBLIC_REQUEST = "GET_RESTAURANTS_CATEGORY_PUBLIC_REQUEST";
export const GET_RESTAURANTS_CATEGORY_PUBLIC_SUCCESS = "GET_RESTAURANTS_CATEGORY_PUBLIC_SUCCESS";
export const GET_RESTAURANTS_CATEGORY_PUBLIC_FAILURE = "GET_RESTAURANTS_CATEGORY_PUBLIC_FAILURE";
