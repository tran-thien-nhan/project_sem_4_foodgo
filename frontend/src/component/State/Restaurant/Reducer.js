    ...
    switch (action.type) {
        ...
        case actionTypes.CREATE_EVENTS_SUCCESS:
            return {
                ...state,
                loading: false,
                events: [...state.categories, action.payload],
                restaurantsEvents: [...state.categories, action.payload],
            };
        ...
        case actionTypes.DELETE_EVENTS_SUCCESS:
            return {
                ...
                restaurantsEvents: state.resstaurantsEvents.filter((item) => item.id !== action.payload),
            };
