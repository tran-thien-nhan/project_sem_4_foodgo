...
export const GET_INGREDIENT_CATEGORIES_REQUEST = 'GET_INGREDIENT_CATEGORIES_REQUEST';
export const GET_INGREDIENT_CATEGORIES_SUCCESS = 'GET_INGREDIENT_CATEGORIES_SUCCESS';
export const GET_INGREDIENT_CATEGORIES_FAILURE = 'GET_INGREDIENT_CATEGORIES_FAILURE';