...
export const GET_RESTAURANTS_ALL_ORDER_REQUEST = 'GET_RESTAURANTS_ALL_ORDER_REQUEST';
export const GET_RESTAURANTS_ALL_ORDER_SUCCESS = 'GET_RESTAURANTS_ALL_ORDER_SUCCESS';
export const GET_RESTAURANTS_ALL_ORDER_FAILURE = 'GET_RESTAURANTS_ALL_ORDER_FAILURE';
