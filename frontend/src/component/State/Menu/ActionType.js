...
export const GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_REQUEST = "GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_REQUEST";
export const GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_SUCCESS = "GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_SUCCESS";
export const GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_FAILURE = "GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_FAILURE";
...
export const GET_INGREDIENTS_OF_MENU_ITEM_REQUEST = "GET_INGREDIENTS_OF_MENU_ITEM_REQUEST";
export const GET_INGREDIENTS_OF_MENU_ITEM_SUCCESS = "GET_INGREDIENTS_OF_MENU_ITEM_SUCCESS";
export const GET_INGREDIENTS_OF_MENU_ITEM_FAILURE = "GET_INGREDIENTS_OF_MENU_ITEM_FAILURE";
