...
const menuItemReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_REQUEST:
            return {
                ...state,
                loading: true,
                error: null,
        ...
        case actionTypes.GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_SUCCESS:
            return {
                ...state,
                loading: false,
        ...
        case actionTypes.UPDATE_MENU_ITEMS_AVAILABILITY_SUCCESS:
            console.log("UPDATE_MENU_ITEMS_AVAILABILITY_SUCCESS: ", action.payload.id);
            return {
                ...state,
                loading: false,
        ...
        case actionTypes.GET_MENU_ITEMS_BY_RESTAURANT_ID_PUBLIC_FAILURE:
            return {
                ...state,
                loading: false,
