...
export const REMOVE_INGREDIENT_OF_ITEM_CART_REQUEST = "REMOVE_INGREDIENT_OF_ITEM_CART_REQUEST";
export const REMOVE_INGREDIENT_OF_ITEM_CART_SUCCESS = "REMOVE_INGREDIENT_OF_ITEM_CART_SUCCESS";
export const REMOVE_INGREDIENT_OF_ITEM_CART_FAILURE = "REMOVE_INGREDIENT_OF_ITEM_CART_FAILURE";